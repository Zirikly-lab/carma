"""
Arabic Mental Health Twitter Collector — ptsd (#8/21)
==========================================================
...
if os.path.exists("/content/drive/MyDrive"):
    INPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-ptsd/input"
    OUTPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-ptsd"
else:
    INPUT_FOLDER = "./input"
...
# ============================================================
# STANDALONE RUNNER — ptsd (#8/21)
# Cookies: cookies_8.json
# Output:  /content/drive/MyDrive/Twitter_Mental_Health-ptsd
# ============================================================

CONDITION = "ptsd"
COOKIES_FILE = "cookies_8.json"

async def run():
    """Run collection for ptsd only."""
    print(f"\n{'='*70}")
    print(f"STANDALONE MODE — ptsd (#8/21)")
    print(f"Cookies: cookies_8.json")
    ...
    if df is not None and len(df) > 0:
        print(f"\n✅ DONE — {len(df):,} tweets collected for ptsd")
        print(f"   File: {filename}")
    else:
        print(f"\n⚠️  No tweets found for ptsd")
