"""
Arabic Mental Health Twitter Collector — panic (#6/21)
==========================================================
...
if os.path.exists("/content/drive/MyDrive"):
    INPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-panic/input"
    OUTPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-panic"
else:
    INPUT_FOLDER = "./input"
...
# ============================================================
# STANDALONE RUNNER — panic (#6/21)
# Cookies: cookies_6.json
# Output:  /content/drive/MyDrive/Twitter_Mental_Health-panic
# ============================================================

CONDITION = "panic"
COOKIES_FILE = "cookies_6.json"

async def run():
    """Run collection for panic only."""
    print(f"\n{'='*70}")
    print(f"STANDALONE MODE — panic (#6/21)")
    print(f"Cookies: cookies_6.json")
    ...
    if df is not None and len(df) > 0:
        print(f"\n✅ DONE — {len(df):,} tweets collected for panic")
        print(f"   File: {filename}")
    else:
        print(f"\n⚠️  No tweets found for panic")
