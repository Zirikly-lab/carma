"""
Arabic Mental Health Twitter Collector — ocd (#7/21)
==========================================================
...
if os.path.exists("/content/drive/MyDrive"):
    INPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-ocd/input"
    OUTPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-ocd"
else:
    INPUT_FOLDER = "./input"
...
# ============================================================
# STANDALONE RUNNER — ocd (#7/21)
# Cookies: cookies_7.json
# Output:  /content/drive/MyDrive/Twitter_Mental_Health-ocd
# ============================================================

CONDITION = "ocd"
COOKIES_FILE = "cookies_7.json"

async def run():
    """Run collection for ocd only."""
    print(f"\n{'='*70}")
    print(f"STANDALONE MODE — ocd (#7/21)")
    print(f"Cookies: cookies_7.json")
    ...
    if df is not None and len(df) > 0:
        print(f"\n✅ DONE — {len(df):,} tweets collected for ocd")
        print(f"   File: {filename}")
    else:
        print(f"\n⚠️  No tweets found for ocd")
