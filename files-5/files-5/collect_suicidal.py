"""
Arabic Mental Health Twitter Collector — suicidal (#21/21)
==========================================================
...
if os.path.exists("/content/drive/MyDrive"):
    INPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-suicidal/input"
    OUTPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-suicidal"
else:
    INPUT_FOLDER = "./input"
...
# ============================================================
# STANDALONE RUNNER — suicidal (#21/21)
# Cookies: cookies_21.json
# Output:  /content/drive/MyDrive/Twitter_Mental_Health-suicidal
# ============================================================
...
async def run():
    ...
    print(f"\n{'='*70}")
    print(f"STANDALONE MODE — suicidal (#21/21)")
    print(f"Cookies: cookies_21.json")
    ...
    if df is not None and len(df) > 0:
        print(f"\n✅ DONE — {len(df):,} tweets collected for suicidal")
        print(f"   File: {filename}")
    else:
        print(f"\n⚠️  No tweets found for suicidal")
