"""
Arabic Mental Health Twitter Collector — schizoid_pd (#18/21)
==========================================================
...
if os.path.exists("/content/drive/MyDrive"):
    INPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-schizoid_pd/input"
    OUTPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-schizoid_pd"
else:
    INPUT_FOLDER = "./input"
...
# ============================================================
# STANDALONE RUNNER — schizoid_pd (#18/21)
# Cookies: cookies_18.json
# Output:  /content/drive/MyDrive/Twitter_Mental_Health-schizoid_pd
# ============================================================

CONDITION = "schizoid_pd"
COOKIES_FILE = "cookies_18.json"

async def run():
    """Run collection for schizoid_pd only."""
    print(f"\n{'='*70}")
    print(f"STANDALONE MODE — schizoid_pd (#18/21)")
    print(f"Cookies: cookies_18.json")
    ...
    if df is not None and len(df) > 0:
        print(f"\n✅ DONE — {len(df):,} tweets collected for schizoid_pd")
        print(f"   File: {filename}")
    else:
        print(f"\n⚠️  No tweets found for schizoid_pd")
