"""
Arabic Mental Health Twitter Collector — schizotypal_pd (#19/21)
==========================================================
...
if os.path.exists("/content/drive/MyDrive"):
    INPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-schizotypal_pd/input"
    OUTPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-schizotypal_pd"
else:
    INPUT_FOLDER = "./input"
...
# ============================================================
# STANDALONE RUNNER — schizotypal_pd (#19/21)
# Cookies: cookies_19.json
# Output:  /content/drive/MyDrive/Twitter_Mental_Health-schizotypal_pd
# ============================================================

CONDITION = "schizotypal_pd"
COOKIES_FILE = "cookies_19.json"

async def run():
    """Run collection for schizotypal_pd only."""
    print(f"\n{'='*70}")
    print(f"STANDALONE MODE — schizotypal_pd (#19/21)")
    print(f"Cookies: cookies_19.json")
    ...
    if df is not None and len(df) > 0:
        print(f"\n✅ DONE — {len(df):,} tweets collected for schizotypal_pd")
        print(f"   File: {filename}")
    else:
        print(f"\n⚠️  No tweets found for schizotypal_pd")
