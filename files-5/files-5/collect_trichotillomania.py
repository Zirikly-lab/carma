"""
Arabic Mental Health Twitter Collector — trichotillomania (#14/21)
==========================================================
...
if os.path.exists("/content/drive/MyDrive"):
    INPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-trichotillomania/input"
    OUTPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-trichotillomania"
else:
    INPUT_FOLDER = "./input"
...
# ============================================================
# STANDALONE RUNNER — trichotillomania (#14/21)
# Cookies: cookies_14.json
# Output:  /content/drive/MyDrive/Twitter_Mental_Health-trichotillomania
# ============================================================

CONDITION = "trichotillomania"
COOKIES_FILE = "cookies_14.json"

async def run():
    """Run collection for trichotillomania only."""
    print(f"\n{'='*70}")
    print(f"STANDALONE MODE — trichotillomania (#14/21)")
    print(f"Cookies: cookies_14.json")
    ...
    if df is not None and len(df) > 0:
        print(f"\n✅ DONE — {len(df):,} tweets collected for trichotillomania")
        print(f"   File: {filename}")
    else:
        print(f"\n⚠️  No tweets found for trichotillomania")
