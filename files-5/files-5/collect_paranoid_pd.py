"""
Arabic Mental Health Twitter Collector — paranoid_pd (#20/21)
==========================================================
...
if os.path.exists("/content/drive/MyDrive"):
    INPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-paranoid_pd/input"
    OUTPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-paranoid_pd"
else:
    INPUT_FOLDER = "./input"
...
# ============================================================
# STANDALONE RUNNER — paranoid_pd (#20/21)
# Cookies: cookies_20.json
# Output:  /content/drive/MyDrive/Twitter_Mental_Health-paranoid_pd
# ============================================================

CONDITION = "paranoid_pd"
COOKIES_FILE = "cookies_20.json"

async def run():
    """Run collection for paranoid_pd only."""
    print(f"\n{'='*70}")
    print(f"STANDALONE MODE — paranoid_pd (#20/21)")
    print(f"Cookies: cookies_20.json")
    ...
    if df is not None and len(df) > 0:
        print(f"\n✅ DONE — {len(df):,} tweets collected for paranoid_pd")
        print(f"   File: {filename}")
    else:
        print(f"\n⚠️  No tweets found for paranoid_pd")
