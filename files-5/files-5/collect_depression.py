"""
Arabic Mental Health Twitter Collector — depression (#4/21)
==========================================================
...
if os.path.exists("/content/drive/MyDrive"):
    INPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-depression/input"
    OUTPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-depression"
else:
    INPUT_FOLDER = "./input"
...
# ============================================================
# STANDALONE RUNNER — depression (#4/21)
# Cookies: cookies_4.json
# Output:  /content/drive/MyDrive/Twitter_Mental_Health-depression
# ============================================================
...
async def run():
    ...
    print(f"\n{'='*70}")
    print(f"STANDALONE MODE — depression (#4/21)")
    print(f"Cookies: cookies_4.json")
    ...
    if df is not None and len(df) > 0:
        print(f"\n✅ DONE — {len(df):,} tweets collected for depression")
        print(f"   File: {filename}")
    else:
        print(f"\n⚠️  No tweets found for depression")
