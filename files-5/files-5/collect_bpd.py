"""
Arabic Mental Health Twitter Collector — bpd (#15/21)
==========================================================
...
if os.path.exists("/content/drive/MyDrive"):
    INPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-bpd/input"
    OUTPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-bpd"
else:
    INPUT_FOLDER = "./input"
...
# ============================================================
# STANDALONE RUNNER — bpd (#15/21)
# Cookies: cookies_15.json
# Output:  /content/drive/MyDrive/Twitter_Mental_Health-bpd
# ============================================================

CONDITION = "bpd"
COOKIES_FILE = "cookies_15.json"

async def run():
    """Run collection for bpd only."""
    print(f"\n{'='*70}")
    print(f"STANDALONE MODE — bpd (#15/21)")
    print(f"Cookies: cookies_15.json")
    ...
    if df is not None and len(df) > 0:
        print(f"\n✅ DONE — {len(df):,} tweets collected for bpd")
        print(f"   File: {filename}")
    else:
        print(f"\n⚠️  No tweets found for bpd")
