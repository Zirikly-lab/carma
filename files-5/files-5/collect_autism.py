"""
Arabic Mental Health Twitter Collector — autism (#11/21)
==========================================================
...
if os.path.exists("/content/drive/MyDrive"):
    INPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-autism/input"
    OUTPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-autism"
else:
    INPUT_FOLDER = "./input"
...
# ============================================================
# STANDALONE RUNNER — autism (#11/21)
# Cookies: cookies_11.json
# Output:  /content/drive/MyDrive/Twitter_Mental_Health-autism
# ============================================================

CONDITION = "autism"
COOKIES_FILE = "cookies_11.json"

async def run():
    """Run collection for autism only."""
    print(f"\n{'='*70}")
    print(f"STANDALONE MODE — autism (#11/21)")
    print(f"Cookies: cookies_11.json")
    ...
    if df is not None and len(df) > 0:
        print(f"\n✅ DONE — {len(df):,} tweets collected for autism")
        print(f"   File: {filename}")
    else:
        print(f"\n⚠️  No tweets found for autism")
