"""
Arabic Mental Health Twitter Collector — anxiety (#5/21)
==========================================================
...
if os.path.exists("/content/drive/MyDrive"):
    INPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-anxiety/input"
    OUTPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-anxiety"
else:
    INPUT_FOLDER = "./input"
...
# ============================================================
# STANDALONE RUNNER — anxiety (#5/21)
# Cookies: cookies_5.json
# Output:  /content/drive/MyDrive/Twitter_Mental_Health-anxiety
# ============================================================
...
async def run():
    """Run collection for anxiety only."""
    print(f"\n{'='*70}")
    print(f"STANDALONE MODE — anxiety (#5/21)")
    print(f"Cookies: cookies_5.json")
    ...
    if df is not None and len(df) > 0:
        print(f"\n✅ DONE — {len(df):,} tweets collected for anxiety")
        print(f"   File: {filename}")
    else:
        print(f"\n⚠️  No tweets found for anxiety")
