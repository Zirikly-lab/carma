"""
Arabic Mental Health Twitter Collector — eating_disorder (#9/21)
==========================================================
...
if os.path.exists("/content/drive/MyDrive"):
    INPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-eating_disorder/input"
    OUTPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-eating_disorder"
else:
    INPUT_FOLDER = "./input"
...
# ============================================================
# STANDALONE RUNNER — eating_disorder (#9/21)
# Cookies: cookies_9.json
# Output:  /content/drive/MyDrive/Twitter_Mental_Health-eating_disorder
# ============================================================

CONDITION = "eating_disorder"
COOKIES_FILE = "cookies_9.json"

async def run():
    """Run collection for eating_disorder only."""
    print(f"\n{'='*70}")
    print(f"STANDALONE MODE — eating_disorder (#9/21)")
    print(f"Cookies: cookies_9.json")
    ...
    if df is not None and len(df) > 0:
        print(f"\n✅ DONE — {len(df):,} tweets collected for eating_disorder")
        print(f"   File: {filename}")
    else:
        print(f"\n⚠️  No tweets found for eating_disorder")
