"""
Arabic Mental Health Twitter Collector — bipolar (#3/21)
==========================================================
...
if os.path.exists("/content/drive/MyDrive"):
    INPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-bipolar/input"
    OUTPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-bipolar"
else:
    INPUT_FOLDER = "./input"
...
# ============================================================
# STANDALONE RUNNER — bipolar (#3/21)
# Cookies: cookies_3.json
# Output:  /content/drive/MyDrive/Twitter_Mental_Health-bipolar
# ============================================================

CONDITION = "bipolar"
COOKIES_FILE = "cookies_3.json"

async def run():
    """Run collection for bipolar only."""
    print(f"\n{'='*70}")
    print(f"STANDALONE MODE — bipolar (#3/21)")
    print(f"Cookies: cookies_3.json")
    ...
    if df is not None and len(df) > 0:
        print(f"\n✅ DONE — {len(df):,} tweets collected for bipolar")
        print(f"   File: {filename}")
    else:
        print(f"\n⚠️  No tweets found for bipolar")
