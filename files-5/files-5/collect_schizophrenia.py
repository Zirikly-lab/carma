"""
Arabic Mental Health Twitter Collector — schizophrenia (#1/21)
==========================================================
...
if os.path.exists("/content/drive/MyDrive"):
    INPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-schizophrenia/input"
    OUTPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-schizophrenia"
else:
    INPUT_FOLDER = "./input"
...
# ============================================================
# STANDALONE RUNNER — schizophrenia (#1/21)
# Cookies: cookies_1.json
# Output:  /content/drive/MyDrive/Twitter_Mental_Health-schizophrenia
# ============================================================

CONDITION = "schizophrenia"
COOKIES_FILE = "cookies_1.json"

async def run():
    """Run collection for schizophrenia only."""
    print(f"\n{'='*70}")
    print(f"STANDALONE MODE — schizophrenia (#1/21)")
    print(f"Cookies: cookies_1.json")
    ...
    if df is not None and len(df) > 0:
        print(f"\n✅ DONE — {len(df):,} tweets collected for schizophrenia")
        print(f"   File: {filename}")
    else:
        print(f"\n⚠️  No tweets found for schizophrenia")
