"""
Arabic Mental Health Twitter Collector — narcissistic_pd (#16/21)
==========================================================
...
if os.path.exists("/content/drive/MyDrive"):
    INPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-narcissistic_pd/input"
    OUTPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-narcissistic_pd"
else:
    INPUT_FOLDER = "./input"
...
# ============================================================
# STANDALONE RUNNER — narcissistic_pd (#16/21)
# Cookies: cookies_16.json
# Output:  /content/drive/MyDrive/Twitter_Mental_Health-narcissistic_pd
# ============================================================

CONDITION = "narcissistic_pd"
COOKIES_FILE = "cookies_16.json"

async def run():
    """Run collection for narcissistic_pd only."""
    print(f"\n{'='*70}")
    print(f"STANDALONE MODE — narcissistic_pd (#16/21)")
    print(f"Cookies: cookies_16.json")
    ...
    if df is not None and len(df) > 0:
        print(f"\n✅ DONE — {len(df):,} tweets collected for narcissistic_pd")
        print(f"   File: {filename}")
    else:
        print(f"\n⚠️  No tweets found for narcissistic_pd")
