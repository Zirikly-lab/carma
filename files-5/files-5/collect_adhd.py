"""
Arabic Mental Health Twitter Collector — adhd (#10/21)
==========================================================
...
if os.path.exists("/content/drive/MyDrive"):
    INPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-adhd/input"
    OUTPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-adhd"
else:
    INPUT_FOLDER = "./input"
...
# ============================================================
# STANDALONE RUNNER — adhd (#10/21)
# Cookies: cookies_10.json
# Output:  /content/drive/MyDrive/Twitter_Mental_Health-adhd
# ============================================================

CONDITION = "adhd"
COOKIES_FILE = "cookies_10.json"

async def run():
    """Run collection for adhd only."""
    print(f"\n{'='*70}")
    print(f"STANDALONE MODE — adhd (#10/21)")
    print(f"Cookies: cookies_10.json")
    ...
    if df is not None and len(df) > 0:
        print(f"\n✅ DONE — {len(df):,} tweets collected for adhd")
        print(f"   File: {filename}")
    else:
        print(f"\n⚠️  No tweets found for adhd")
