"""
Arabic Mental Health Twitter Collector — avoidant_pd (#17/21)
==========================================================
...
if os.path.exists("/content/drive/MyDrive"):
    INPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-avoidant_pd/input"
    OUTPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-avoidant_pd"
else:
    INPUT_FOLDER = "./input"
...
# ============================================================
# STANDALONE RUNNER — avoidant_pd (#17/21)
# Cookies: cookies_17.json
# Output:  /content/drive/MyDrive/Twitter_Mental_Health-avoidant_pd
# ============================================================

CONDITION = "avoidant_pd"
COOKIES_FILE = "cookies_17.json"

async def run():
    """Run collection for avoidant_pd only."""
    print(f"\n{'='*70}")
    print(f"STANDALONE MODE — avoidant_pd (#17/21)")
    print(f"Cookies: cookies_17.json")
    ...
    if df is not None and len(df) > 0:
        print(f"\n✅ DONE — {len(df):,} tweets collected for avoidant_pd")
        print(f"   File: {filename}")
    else:
        print(f"\n⚠️  No tweets found for avoidant_pd")
