"""
Arabic Mental Health Twitter Collector — sleep_disorder (#13/21)
==========================================================
...
if os.path.exists("/content/drive/MyDrive"):
    INPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-sleep_disorder/input"
    OUTPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-sleep_disorder"
else:
    INPUT_FOLDER = "./input"
...
# ============================================================
# STANDALONE RUNNER — sleep_disorder (#13/21)
# Cookies: cookies_13.json
# Output:  /content/drive/MyDrive/Twitter_Mental_Health-sleep_disorder
# ============================================================

CONDITION = "sleep_disorder"
COOKIES_FILE = "cookies_13.json"

async def run():
    """Run collection for sleep_disorder only."""
    print(f"\n{'='*70}")
    print(f"STANDALONE MODE — sleep_disorder (#13/21)")
    print(f"Cookies: cookies_13.json")
    ...
    if df is not None and len(df) > 0:
        print(f"\n✅ DONE — {len(df):,} tweets collected for sleep_disorder")
        print(f"   File: {filename}")
    else:
        print(f"\n⚠️  No tweets found for sleep_disorder")
