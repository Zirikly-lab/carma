"""
Arabic Mental Health Twitter Collector — did (#12/21)
==========================================================
...
if os.path.exists("/content/drive/MyDrive"):
    INPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-did/input"
    OUTPUT_FOLDER = "/content/drive/MyDrive/Twitter_Mental_Health-did"
else:
    INPUT_FOLDER = "./input"
...
# ============================================================
# STANDALONE RUNNER — did (#12/21)
# Cookies: cookies_12.json
# Output:  /content/drive/MyDrive/Twitter_Mental_Health-did
# ============================================================

CONDITION = "did"
COOKIES_FILE = "cookies_12.json"

async def run():
    """Run collection for did only."""
    print(f"\n{'='*70}")
    print(f"STANDALONE MODE — did (#12/21)")
    print(f"Cookies: cookies_12.json")
    ...
    if df is not None and len(df) > 0:
        print(f"\n✅ DONE — {len(df):,} tweets collected for did")
        print(f"   File: {filename}")
    else:
        print(f"\n⚠️  No tweets found for did")
